        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#">Reservacion</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index_alumno.php">Clientes</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index_eventos.php">otra cosa</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <form id="myForm">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <input type="text" name="job" id="job" class="form-control" placeholder="Trabajo" required>
                            </div>
                        </div><br>
                        <div class="row">
                            <div class="col">
